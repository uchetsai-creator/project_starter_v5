# Workflow Plan — feature / microservices+web-app
Generated: {{TIMESTAMP}}
...
3. `python3 docs/script/validators/verify_docs.py --project-type microservices+web-app --content`
4. `python3 docs/script/validators/verify_logs.py --project-type microservices+web-app --strict`
5. `python3 docs/script/validators/verify_content.py --project-type microservices+web-app --strict`
6. `python3 docs/script/validators/verify_spec_code.py --project-type microservices+web-app --strict`
7. `python3 docs/script/validators/verify_security.py --project-type microservices+web-app --strict`
...
> **Note:** if `.codex/task-instructions.md` shows `# Workflow Plan — feature / microservices+web-app
Generated: {{TIMESTAMP}}

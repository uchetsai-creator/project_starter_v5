...
- docs/specs/mobile-contract.md   # Screen inventory, navigation structure, OS permissions, and push notification schemas
    update when: screen added, removed, or navigation structure changed; deep links, OS permissions, push notification payloads, or store metadata changed

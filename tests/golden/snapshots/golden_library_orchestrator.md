...
3. `python3 docs/script/validators/verify_docs.py --project-type library --content`
4. `python3 docs/script/validators/verify_logs.py --project-type library --strict`
5. `python3 docs/script/validators/verify_content.py --project-type library --strict`
6. `python3 docs/script/validators/verify_spec_code.py --project-type library --strict`
7. `python3 docs/script/validators/verify_security.py --project-type library --strict`
...
> **Note:** if `.codex/task-instructions.md` shows `# Workflow Plan — feature / library
Generated: {{TIMESTAMP}}

...
3. `python3 docs/script/validators/verify_docs.py --project-type mobile-app --content`
4. `python3 docs/script/validators/verify_logs.py --project-type mobile-app --strict`
5. `python3 docs/script/validators/verify_content.py --project-type mobile-app --strict`
6. `python3 docs/script/validators/verify_spec_code.py --project-type mobile-app --strict`
7. `python3 docs/script/validators/verify_security.py --project-type mobile-app --strict`
...
> **Note:** if `.codex/task-instructions.md` shows `# Workflow Plan — feature / mobile-app
Generated: {{TIMESTAMP}}

...
1. `python3 docs/script/validators/verify_docs.py --project-type llm-app --content`
2. `python3 docs/script/validators/verify_content.py --project-type llm-app --strict`

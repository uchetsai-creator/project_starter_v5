...
3. `python3 docs/script/validators/verify_docs.py --project-type llm-app --content`
4. `python3 docs/script/validators/verify_content.py --project-type llm-app --strict`
5. `python3 docs/script/validators/verify_spec_code.py --project-type llm-app --strict`
6. `python3 docs/script/validators/verify_security.py --project-type llm-app --strict`
...
> **Note:** if `.codex/task-instructions.md` shows `# Workflow Plan — eval-run / llm-app
Generated: {{TIMESTAMP}}

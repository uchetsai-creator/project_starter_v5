...
3. `python3 docs/script/validators/verify_docs.py --project-type cli-tool --content`
4. `python3 docs/script/validators/verify_logs.py --project-type cli-tool --strict`
5. `python3 docs/script/validators/verify_content.py --project-type cli-tool --strict`
6. `python3 docs/script/validators/verify_spec_code.py --project-type cli-tool --strict`
7. `python3 docs/script/validators/verify_security.py --project-type cli-tool --strict`
...
> **Note:** if `.codex/task-instructions.md` shows `# Workflow Plan — feature / cli-tool
Generated: {{TIMESTAMP}}
